...
class QueryingTestCase(unittest.TestCase):
	...
	def test_find_docs_disj_empty(self):
		...
		"bright": {3:1}}
		query = "Carrefour, tudududu!"
		dicOfDocs = querying.naive_disj_algo(self._index._inv_index, set(querying.get_terms(query)))
	...
	def test_find_docs_disj_normal(self):
		...
		"bright": {3:1}}
		query = "and as both"
		dicOfDocs = querying.naive_disj_algo(invertedFile, set(querying.get_terms(query)))
	...
	def test_find_docs_conj_empty(self):
		...
		dicOfDocs = querying.naive_conj_algo(self._index._inv_index, set(querying.get_terms(query)))
		self.assertEqual(dicOfDocs,{})
